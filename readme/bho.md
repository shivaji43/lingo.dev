...
**Lingo.dev Compiler** एगो मुफ्त, ओपन-सोर्स कंपाइलर मिडलवेयर बा, जवन कवनो भी React ऐप के बिल्ड टाइम पर बहुभाषी बनावे खातिर डिजाइन कइल गइल बा बिना मौजूदा React कंपोनेंट्स में कवनो बदलाव के।

> **नोट:** अगर रउआ लिगेसी कंपाइलर (`@lingo.dev/_compiler`) के इस्तेमाल करत बानी, त कृपया `@lingo.dev/compiler` पर माइग्रेट करीं। लिगेसी कंपाइलर डिप्रिकेटेड बा आ भविष्य के रिलीज में हटा दिहल जाई।
...
`next build` चलाईं आ स्पेनिश आ फ्रेंच बंडल्स के बाहर आवत देखीं ✨
...
[दस्तावेज़ के फॉलो करीं →](https://lingo.dev/cli) ई जाने खातिर कि एकरा के कइसे सेट अप करल जाला।
...
अपना रेपो के हरियर आ अपना प्रोडक्ट के बहुभाषी बनवले रहेला बिना मैनुअल स्टेप के।
...
हम समुदाय-संचालित बानी आ योगदान के प्यार करेनी!
...
अगर रउआ के हमनी के काम पसंद बा, त हमनी के एगो ⭐ दीं आ 10,000 स्टार तक पहुँचे में मदद करीं! 🌟
...
**Locale format:** [BCP-47](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) कोड इस्तेमाल करीं: `language[-Script][-REGION]`
