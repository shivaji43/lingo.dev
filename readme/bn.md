...
> **নোট:** আপনি যদি লিগ্যাসি কম্পাইলার (`@lingo.dev/_compiler`) ব্যবহার করেন, তাহলে অনুগ্রহ করে `@lingo.dev/compiler`-এ মাইগ্রেট করুন। লিগ্যাসি কম্পাইলারটি অবচিত এবং ভবিষ্যতের রিলিজে সরিয়ে ফেলা হবে।
...
| **CI/CD**    | প্রতিটি পুশে স্বয়ংক্রিয়ভাবে অনুবাদ কমিট করুন + প্রয়োজনে pull request তৈরি করুন          | [/ci](https://lingo.dev/ci)             |
| **SDK**      | ইউজার-জেনারেটেড কন্টেন্টের জন্য রিয়েলটাইম অনুবাদ                                          | [/sdk](https://lingo.dev/sdk)           |

প্রতিটির জন্য দ্রুত হাইলাইট নিচে দেওয়া হলো 👇
...
[ডকুমেন্টেশন দেখুন →](https://lingo.dev/cli) কীভাবে সেটআপ করবেন তা জানতে।
...
ম্যানুয়াল ধাপ ছাড়াই আপনার রিপো সবুজ এবং আপনার প্রোডাক্ট বহুভাষিক রাখে।
...
আমরা কমিউনিটি-চালিত এবং কন্ট্রিবিউশন পছন্দ করি!
...
আমরা যা করছি তা যদি আপনার পছন্দ হয়, আমাদের একটি ⭐ দিন এবং ১০,০০০ স্টারে পৌঁছাতে সাহায্য করুন! 🌟
