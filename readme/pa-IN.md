...
> **ਨੋਟ:** ਜੇਕਰ ਤੁਸੀਂ ਲੈਗੇਸੀ ਕੰਪਾਈਲਰ (`@lingo.dev/_compiler`) ਵਰਤ ਰਹੇ ਹੋ, ਤਾਂ ਕਿਰਪਾ ਕਰਕੇ `@lingo.dev/compiler` ਵਿੱਚ ਮਾਈਗ੍ਰੇਟ ਕਰੋ। ਲੈਗੇਸੀ ਕੰਪਾਈਲਰ ਨੂੰ ਡੈਪਰੀਕੇਟ ਕੀਤਾ ਗਿਆ ਹੈ ਅਤੇ ਭਵਿੱਖ ਦੀ ਰਿਲੀਜ਼ ਵਿੱਚ ਹਟਾ ਦਿੱਤਾ ਜਾਵੇਗਾ।
...
| **CI/CD**    | ਹਰ ਪੁਸ਼ 'ਤੇ ਆਟੋ-ਕਮਿਟ ਅਨੁਵਾਦ + ਲੋੜ ਪੈਣ 'ਤੇ pull requests ਬਣਾਓ               | [/ci](https://lingo.dev/ci)             |
| **SDK**      | ਉਪਭੋਗਤਾ-ਜਨਰੇਟਿਡ ਸਮੱਗਰੀ ਲਈ ਰੀਅਲਟਾਈਮ ਅਨੁਵਾਦ                                  | [/sdk](https://lingo.dev/sdk)           |

ਹੇਠਾਂ ਹਰੇਕ ਲਈ ਤੇਜ਼ ਹਿੱਟ ਹਨ 👇
...
ਇਸਨੂੰ ਸੈੱਟਅੱਪ ਕਰਨ ਦਾ ਤਰੀਕਾ ਸਿੱਖਣ ਲਈ [ਦਸਤਾਵੇਜ਼ ਫਾਲੋ ਕਰੋ →](https://lingo.dev/cli)।
...
ਤੁਹਾਡੇ ਰਿਪੋ ਨੂੰ ਗ੍ਰੀਨ ਅਤੇ ਤੁਹਾਡੇ ਪ੍ਰੋਡਕਟ ਨੂੰ ਮੈਨੁਅਲ ਸਟੈਪਸ ਤੋਂ ਬਿਨਾਂ ਬਹੁਭਾਸ਼ਾਈ ਰੱਖਦਾ ਹੈ।
...
ਆਪਣੀ ਭਾਸ਼ਾ ਨਹੀਂ ਦਿਖਾਈ ਦੇ ਰਹੀ? ਇਸਨੂੰ `i18n.json` ਵਿੱਚ ਸ਼ਾਮਲ ਕਰੋ ਅਤੇ ਇੱਕ PR ਖੋਲ੍ਹੋ!
