...
`next build` ධාවනය කර ස්පාඤ්ඤ සහ ප්‍රංශ bundle එළියට එන ආකාරය නරඹන්න ✨
...
අතින් කළ යුතු පියවර නොමැතිව ඔබේ repo එක හරිත ලෙස සහ ඔබේ නිෂ්පාදනය බහුභාෂා ලෙස තබා ගනී.
...
- උදාහරණ: `en`, `pt-BR`, `zh-Hans`, {/_ INLINE_CODE_PLACEHOLDER_6e553bb40a655db7be211ded60744c98 _/
