...
**Lingo.dev Compiler** ایک مفت، اوپن سورس کمپائلر مڈل ویئر ہے، جو کسی بھی React ایپ کو بلڈ ٹائم پر کثیر لسانی بنانے کے لیے ڈیزائن کیا گیا ہے بغیر موجودہ React کمپوننٹس میں کوئی تبدیلی کیے۔

> **نوٹ:** اگر آپ پرانا کمپائلر (`@lingo.dev/_compiler`) استعمال کر رہے ہیں، تو براہ کرم `@lingo.dev/compiler` میں منتقل ہو جائیں۔ پرانا کمپائلر فرسودہ ہو چکا ہے اور مستقبل کی ریلیز میں ہٹا دیا جائے گا۔
...
`next build` چلائیں اور ہسپانوی اور فرانسیسی بنڈلز کو سامنے آتے دیکھیں ✨
...
| ٹول          | TL;DR                                                                           | دستاویزات                               |
| ------------ | ------------------------------------------------------------------------------- | --------------------------------------- |
| **Compiler** | بلڈ ٹائم React لوکلائزیشن                                                       | [/compiler](https://lingo.dev/compiler) |
| **CLI**      | ویب اور موبائل ایپس، JSON، YAML، markdown، اور مزید کے لیے ایک کمانڈ لوکلائزیشن | [/cli](https://lingo.dev/cli)           |
| **CI/CD**    | ہر push پر خودکار ترجمے کمٹ کریں + ضرورت پڑنے پر pull requests بنائیں           | [/ci](https://lingo.dev/ci)             |
| **SDK**      | صارف کے تیار کردہ مواد کے لیے ریئل ٹائم ترجمہ                                   | [/sdk](https://lingo.dev/sdk)           |

ہر ایک کے لیے فوری خلاصہ ذیل میں ہے 👇
...
یہ ہر سٹرنگ کو فنگر پرنٹ کرتا ہے، نتائج کو کیش کرتا ہے، اور صرف تبدیل شدہ حصوں کا دوبارہ ترجمہ کرتا ہے۔
...
آپ کے ریپو کو سبز اور آپ کی پروڈکٹ کو کثیر لسانی رکھتا ہے بغیر دستی اقدامات کے۔
...
چیٹ، صارف کے تبصروں، اور دیگر حقیقی وقت کے عمل کے لیے بہترین۔
...
**Locale فارمیٹ:** [BCP-47](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale) کوڈز استعمال کریں: `language[-Script][-REGION]`

- زبان: ISO 639-1/2/3 چھوٹے حروف (`en`, `zh`, `bho`)
- رسم الخط: ISO 15924 ٹائٹل کیس (`Hans`, `Hant`, `Latn`)
- علاقہ: ISO 3166-1 alpha-2 بڑے حروف (`US`, `CN`, `IN`)
